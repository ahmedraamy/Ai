...
lr = load(open('movie_reviews/app2/artifacts/lr.pkl', 'rb'))
dt = load(open('movie_reviews/app2/artifacts/dt.pkl', 'rb'))
svc = load(open('movie_reviews/app2/artifacts/svc.pkl', 'rb'))
try:
